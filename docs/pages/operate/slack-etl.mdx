...
[Temporary Slack search answers](/operate/slack-search) use a separate live
retrieval path. Its channel-only restrictions do not change this index's
permissions or the user-scoped ingestion described below.
